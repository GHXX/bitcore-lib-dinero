...
# Governance Object
A Governance Object (or "govObject") is a generic structure introduced in Dinero Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
####  `checkedSerialize`
Return an hexa string that can be used in dinerod CLI
####  `serialize`
...
var jsonProposal = {
  ...
  url:"http://www.dinero.org/proposal/first_proposal"
};
...
```javascript
proposal.url="http://dinero.org/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url="http://dinero.org/fixedUrl"
